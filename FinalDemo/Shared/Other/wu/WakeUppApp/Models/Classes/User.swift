...
public final class User: NSObject, NSCoding {
    ...
    private struct SerializationKeys {
        ...
        static let groupData = "group_data"
    ...
    public required init(json: JSON) {
        ...
        if let items = json[SerializationKeys.groupData].array { groupData = items.map { $0.object} }
    ...
    public func dictionaryRepresentation() -> [String: Any] {
        ...
        if let value = groupData { dictionary[SerializationKeys.groupData] = value }
    ...
    required public init(coder aDecoder: NSCoder) {
        ...
        self.groupData = aDecoder.decodeObject(forKey: SerializationKeys.groupData) as? [Any]
    ...
    public func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(groupData, forKey: SerializationKeys.groupData)
