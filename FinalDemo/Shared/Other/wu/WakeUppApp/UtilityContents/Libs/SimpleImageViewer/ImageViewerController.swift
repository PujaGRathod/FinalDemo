...
public final class ImageViewerController: UIViewController {
    ...
    @IBOutlet fileprivate var btnsave: UIButton!
    ...
    {
        let activityItem: [AnyObject] = [imageView.image as AnyObject]
        
        let avc = UIActivityViewController(activityItems: activityItem as [AnyObject], applicationActivities: nil)
        avc.excludedActivityTypes = [ UIActivityType.airDrop, UIActivityType.postToFacebook,UIActivityType.postToVimeo,UIActivityType.postToWeibo,UIActivityType.postToFlickr,UIActivityType.postToTwitter,UIActivityType.assignToContact,UIActivityType.copyToPasteboard,UIActivityType.addToReadingList,UIActivityType.print]
        self.present(avc, animated: true, completion: nil)
        //custom activity - http://www.theappguruz.com/blog/share-extension-in-ios-8
    }
