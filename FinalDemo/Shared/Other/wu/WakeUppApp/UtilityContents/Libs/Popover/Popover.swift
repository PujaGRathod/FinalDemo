...
open class Popover: UIView {
    ...
    open var POcornerRadius: CGFloat = 6.0
    ...
    open func show(_ contentView: UIView, point: CGPoint, inView: UIView) {
        ...
        self.contentView.layer.cornerRadius = self.POcornerRadius
    ...
    override open func draw(_ rect: CGRect) {
        ...
        case .up:
            ...
            arrow.addLine(to: CGPoint(x: self.POcornerRadius, y: self.bounds.height - self.arrowSize.height))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.POcornerRadius,
                    y: self.bounds.height - self.arrowSize.height - self.POcornerRadius
                ),
                radius: self.POcornerRadius,
                startAngle: self.radians(90),
                endAngle: self.radians(180),
                clockwise: true)
            
            arrow.addLine(to: CGPoint(x: 0, y: self.POcornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.POcornerRadius,
                    y: self.POcornerRadius
                ),
                radius: self.POcornerRadius,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.POcornerRadius, y: 0))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.POcornerRadius,
                    y: self.POcornerRadius
                ),
                radius: self.POcornerRadius,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.arrowSize.height - self.POcornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.POcornerRadius,
                    y: self.bounds.height - self.arrowSize.height - self.POcornerRadius
        ...
        case .down, .auto:
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.POcornerRadius, y: self.arrowSize.height))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.POcornerRadius,
                    y: self.arrowSize.height + self.POcornerRadius
                ),
                radius: self.POcornerRadius,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.POcornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.POcornerRadius,
                    y: self.bounds.height - self.POcornerRadius
                ),
                radius: self.POcornerRadius,
                startAngle: self.radians(0),
                endAngle: self.radians(90),
            ...
            arrow.addLine(to: CGPoint(x: 0, y: self.arrowSize.height + self.POcornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.POcornerRadius,
                    y: self.arrowSize.height + self.POcornerRadius
