//
//  ChatStoryReplyReceiverCell.swift
//  WakeUppApp
//
...
protocol ChatReceiverStoryReplyCellDelegate:class
{
    func btnStoryMineClicked(_ sender: UIButton)
}

class ChatStoryReplyReceiverCell: UITableViewCell {

    weak var chatReceiverStoryReplyCellDelegate: ChatReceiverStoryReplyCellDelegate?
    ...
    @IBAction func btnViewClicked(_ sender: UIButton) {
        self.chatReceiverStoryReplyCellDelegate?.btnStoryMineClicked(sender)
    }
