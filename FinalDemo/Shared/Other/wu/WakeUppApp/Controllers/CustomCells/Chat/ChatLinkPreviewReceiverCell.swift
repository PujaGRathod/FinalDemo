//
//  ChatLinkPreviewReceiverCell.swift
//  WakeUppApp
//
...
protocol ChatLinkPreviewReceiverCellDelegate:class
{
    func btnLinkMineClicked(_ sender: UIButton)
}

class ChatLinkPreviewReceiverCell: UITableViewCell {

    weak var chatLinkPreviewReceiverCellDelegate: ChatLinkPreviewReceiverCellDelegate?
    ...
    @IBAction func btnLinkClicked(_ sender: Any) {
        self.chatLinkPreviewReceiverCellDelegate?.btnLinkMineClicked(sender as! UIButton)
    }
